...
img = loadImg('../img/solitary/2021-07-02-1530-03-10-22.JPG', gray=True)
img = scaleImg(img)
img2 = loadImg('../img/solitary/2021-07-02-1530-03-10-22.JPG')
img2 = scaleImg(img2)
...
for i in range(len(contours)-2):
    ...
    if hierarchy[0][i][3] == -1 and area > 190 and area < 3000000:
        ...
        cX = int(M["m10"] / M["m00"])
        cY = int(M["m01"] / M["m00"])
        if cY < img.shape[0] - 550 and cX < img.shape[1] - 200 and (cY * cX) > 99000 and cY > 300 and cX > 200:
            # contour approximation ("smoothing")
            epsilon = 0.011*cv2.arcLength(contours[i], True)  # reduce points (remnant)
...
cv2.imshow("Image", scaleImg(loadImg('../img/solitary/2021-07-02-1530-03-10-22.JPG')))
...
while True:
    ...
    if key == 115:
        cv2.imwrite('../img/solitary/2021-07-02-1530-03-10-22_contours_out.jpg', out)
        cv2.imwrite('../img/solitary/2021-07-02-1530-03-10-22_contours_out1.jpg', out1)
        break
    if key == 27:
        break
